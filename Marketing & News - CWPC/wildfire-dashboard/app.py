...
csv_path = os.path.join(base_path, "wildfire_news_final.csv")
...
img_path = os.path.join(base_path, "wildfire_bg.jpg")
bg_img = get_base64(img_path)

# -----------------------------
# CSS (FIXED + RIGHT SHIFT)
st.markdown(f"""
<style>
